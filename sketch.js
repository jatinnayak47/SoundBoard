...
function setup() {
  ...
  retro_game = loadSound('mixkit-classic.wav');
  whoosh = loadSound('mixkit-cricket.wav');
  acute_guitar = loadSound('mixkit-dog.wav');
  guitar_string = loadSound('mixkit-fastrocket.wav');
  guitar_notif = loadSound('mixkit-retro-game.wav');
